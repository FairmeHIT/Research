%The script can be used to count the number of handover 
...
%Output:
% Num_handover_kN_fuzzyBased_Dir -> Number of handovers with fuzzy&Dir-based method for different AP numbers
% Num_PP_handover_kN_fuzzyBased_Dir -> Number of PP handovers with fuzzy&Dir-based method for different AP numbers
% Num_handover_kN_fuzzyBased_nonDir -> Number of handovers with fuzzy-based method for different AP numbers
% Num_PP_handover_kN_fuzzyBased_nonDir -> Number of PP handovers with fuzzy-based method for different AP numbers 
% Num_handover_kN_LSFC -> Number of handovers with LSFC-based method for different AP numbers
% Num_PP_handover_kN_LSFC -> Number of PP handovers with LSFC-based method for different AP numbers
...
for n = 1:N
    ...
    for num_AP_i = 1:length(num_AP_number)  
        ...
        for n_i = 1:length(n_p_r)   
            disp(['  [num_AP_i = ' num2str(num_AP_i) ', All = ' num2str(length(num_AP_number)) ']'... 
            '  [n_i = ' num2str(n_i) ', All = ' num2str(length(n_p_r)) ']' ...
            ...
            for rician_i = 1:length(Rician_range) 
                ...
                if rician_flag == 1 
                    ...
                    switch num_AP_i
                        case 1 
                            fis=readfis('handoverFuzzyRician1');  
                        case 2 
                            fis=readfis('handoverFuzzyRician2');  
                        case 3 
                            fis=readfis('handoverFuzzyRician3');  
                        case 4 
                            fis=readfis('handoverFuzzyRician4');  
                        case 5 
                            fis=readfis('handoverFuzzyRician5');  
                        otherwise 
                            disp('no fuzzy set!!!')
                    end  
                else
                    fis=readfis('handover_fuzzy_Rayleigh');  
                ...
                if n_yipi == 0  
                    ...
                    [U_fuzzy1, set_index_delete_fuzzy1,Num_handover_kN_fuzzyBased_Dir(1:K,n_i,num_AP_i,n),Num_PP_handover_kN_fuzzyBased_Dir(1:K,n_i,num_AP_i,n)] = ...
                   ...
                   %Prepare to store the values of HOM
                    ...
                    [U_fuzzy2, set_index_delete_fuzzy2,Num_handover_kN_fuzzyBased_nonDir(1:K,n_i,num_AP_i,n),Num_PP_handover_kN_fuzzyBased_nonDir(1:K,n_i,num_AP_i,n)] = ...
                    ...
                    [U_LSFC,set_index_delete_LSFC,Num_handover_kN_LSFC(1:K,n_i,num_AP_i,n),Num_PP_handover_kN_LSFC(1:K,n_i,num_AP_i,n)] = ...
