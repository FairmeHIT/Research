...
%Output:
% Num_handover_kN_fuzzyBased_Dir -> Number of handovers with fuzzy&Dir-based method for different serving AP numbers
% Num_PP_handover_kN_fuzzyBased_Dir -> Number of PP handovers with fuzzy&Dir-based method for different serving AP numbers
% Num_handover_kN_fuzzyBased_nonDir -> Number of handovers with fuzzy-based method for different serving AP numbers
% Num_PP_handover_kN_fuzzyBased_nonDir -> Number of PP handovers with fuzzy-based method for different serving AP numbers
% Num_handover_kN_LSFC -> Number of handovers with LSFC-based method for different serving AP numbers
% Num_PP_handover_kN_LSFC -> Number of PP handovers with LSFC-based method for different serving AP numbers
...
Rician_range = [1];   
max_num_APserving_range = [1:10]; %for all AP in this network 
